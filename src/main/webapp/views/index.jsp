...
<head>
  ...
  padding-top: 40px;*/
		...
		* {}
		...
		< style>@import url('https://fonts.googleapis.com/css2?family=Titillium+Web:wght@200;300&display=swap');
		...
		<div class="container-fostrap">
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						...
						<ul class="navbar-nav">
							...
							<li class="nav-item active"><a class="nav-link" sec:authorize="isAuthenticated()"
						...
						<div class="row">
							<div id="sliderproduct" class="carousel slide " data-ride="carousel" data-interval="10000">
								...
								<div class="carousel-inner" role="listbox" data-interval="10000000">
											...
											<div class="row">
												...
												<div class="col-sm-6">
													<div class="top d-flex justify-content-center">
														<a href=""><b>2</b> <br>days</a> <a href=""><b>20</b>
															<br> hours</a> <a href=""><b>15</b> <br>min</a> <a
															href=""><b>2</b> <br> sec</a>
													</div>
													<!--endtop-->
													<div class="details">
														...
														<p class="cr4">
															tomato, green salad, pita,<br> ketchup, mayonnaise,
															….
														</p>
														<div class="rating">
										...
										<div class="container text-center">
											<div class="row">
												<div class="col-sm-6 image">
													<div class="item">
														<h1>Today's Deal</h1>
														<img class="img-fluid" src="https://hungryhealthyhappy.com/wp-content/uploads/2022/12/fruit-platter-featured.jpg" alt="">
													</div>
													<!--enditem-->
												</div>
												<!--endcol-->
									...
									<!--endcarousel-item-->
									<a class="carousel-control-prev fa fa-angle-left" href="#sliderproduct"
										role="button" data-slide="prev"> </a> <a
										class="carousel-control-next fa fa-angle-right" href="#sliderproduct"
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4" data-aos="zoom-in-down">
					<div class="card">
						<a class="img-card"> <img
								src="https://t4.ftcdn.net/jpg/03/37/96/33/360_F_337963325_EJuPjWslX3vAFxJ59L3y1cm6IsSfo07s.jpg" class="tab2image"/>
